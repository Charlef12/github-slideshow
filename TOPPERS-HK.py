#coding=utf-8
#!/usr/bin/python2
#Originally Written By Dammy_Prince
try:
...
header={'x-fb-connection-bandwidth': repr(bd),'x-fb-sim-hni': repr(sim),'x-fb-net-hni': repr(sim),'x-fb-connection-quality': 'EXCELLENT','x-fb-connection-type': 'cell.CTRadioAccessTechnologyHSDPA','user-agent':'Mozilla/5.0 (Linux; Android 9; Infinix X650B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.116 Mobile Safari/537.36','content-type': 'application/x-www-form-urlencoded','x-fb-http-engine': 'Liger'}
reload(sys)
...
#MyLogo
def logo():
    os.system('echo -e "\n\n馃嚢.馃嚘.馃嚚.馃嚟.馃嚠\n\n-----------------------------------------------\n\n鉃� Codded By : Igwilo Emilia Afoma\n鉃� Facebook  : Igwilo Emilia Afoma Whatsapp   : +2348143667579\n鉃� Youtube   : No YouTube Channel Yet\n\n-----------------------------------------------" | lolcat')
def method_
    os.system("clear")
    logo()
    print("")
